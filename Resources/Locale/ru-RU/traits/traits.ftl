...
trait-monochromacy-desc = Вы полностью дальтоник, всё что вы воспринимаете окрашено от чёрного до белого.
trait-monochromancy-name = Монохромания
trait-monochromancy-desc = Вы полностью лишены цветового восприятия, всё, что вы видите, представлено оттенками от чёрного до белого.
