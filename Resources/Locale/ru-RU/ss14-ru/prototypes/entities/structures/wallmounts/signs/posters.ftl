...
ent-PosterLegitHelio = Рекламный плакат Helio Logistics
    .desc = Плакат, рекламирующий Helio Logistics и их очаровательного талисмана. Слоган гласит: 'Идёт дождь или светит солнце — мы доставим вовремя'.
