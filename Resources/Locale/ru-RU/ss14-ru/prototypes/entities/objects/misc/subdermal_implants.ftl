...
ent-DeathRattleImplantCentcomm = имплант предсмертного хрипа Центком
    .desc = Этот имплант оповестит радиоканал Центком, если пользователь окажется в критическом состоянии или умрёт.
