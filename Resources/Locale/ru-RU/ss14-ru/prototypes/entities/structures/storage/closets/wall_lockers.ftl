...
ent-ClosetWallAtmospherics = атмосферный настенный шкаф
    .desc = { ent-BaseWallCloset.desc }
ent-LockerWallEvacRepair = аварийный настенный шкаф эвакуационного шаттла
    .desc = Тут происходят аварии одна за другой.
ent-LockerWallBasePrisoner = настенный шкаф заключённого
    .desc = Это безопасное хранилище для личных вещей заключённого во время его пребывания в тюрьме.
    .suffix = 1
