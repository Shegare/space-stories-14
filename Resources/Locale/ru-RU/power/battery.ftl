...
battery-menu-storage-header = Аккумуляторы хранения
battery-menu-passthrough = Проходной режим
battery-menu-max = Макс.:
battery-menu-current = Текущая:
battery-menu-stored = Хранится:
battery-menu-energy = Энергия:
battery-menu-eta-full = ETA (полностью):
