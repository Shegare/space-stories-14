...
ent-DoorRemoteCustom = пульт от шлюзов настройки
    .desc = Гаджет, который может открывать и запирать двери дистанционно. Этот продвинутый вариант не имеет встроенного доступа, а вместо этого наследует права доступа пользователя.
