...
artifact-unlock-state-begin = Начинает меняться странным образом...
artifact-unlock-state-end-success = Замедляется, заметно меняясь.
artifact-unlock-state-end-failure = Замедляется прежде чем остановиться без происшествий.
...
artifact-node-class-5 = [color=#7883ff]Светило[/color]
