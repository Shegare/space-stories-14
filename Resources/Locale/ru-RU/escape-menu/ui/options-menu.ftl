...
ui-options-function-hotbar-shift1 = Хотбар слот Shift+1
ui-options-function-hotbar-shift2 = Хотбар слот Shift+2
ui-options-function-hotbar-shift3 = Хотбар слот Shift+3
ui-options-function-hotbar-shift4 = Хотбар слот Shift+4
ui-options-function-hotbar-shift5 = Хотбар слот Shift+5
ui-options-function-hotbar-shift6 = Хотбар слот Shift+6
ui-options-function-hotbar-shift7 = Хотбар слот Shift+7
ui-options-function-hotbar-shift8 = Хотбар слот Shift+8
ui-options-function-hotbar-shift9 = Хотбар слот Shift+9
ui-options-function-hotbar-shift0 = Хотбар слот Shift+0
...
ui-options-function-loadoutshift1 = Хотбар Лодаут Shift+1
ui-options-function-loadoutshift2 = Хотбар Лодаут Shift+2
ui-options-function-loadoutshift3 = Хотбар Лодаут Shift+3
ui-options-function-loadoutshift4 = Хотбар Лодаут Shift+4
ui-options-function-loadoutshift5 = Хотбар Лодаут Shift+5
ui-options-function-loadoutshift6 = Хотбар Лодаут Shift+6
ui-options-function-loadoutshift7 = Хотбар Лодаут Shift+7
ui-options-function-loadoutshift8 = Хотбар Лодаут Shift+8
ui-options-function-loadoutshift9 = Хотбар Лодаут Shift+9
ui-options-function-loadoutshift0 = Хотбар Лодаут Shift+0
...
ui-options-function-text-newline = Перевод строки
ui-options-function-text-submit = Отправить
ui-options-function-multiline-text-submit = Отправить (многострочный ввод)
ui-options-function-text-select-all = Выделить всё
ui-options-function-text-copy = Скопировать
...
ui-options-function-text-release-focus = Освободить фокус
ui-options-function-text-scroll-to-bottom = Прокрутить вниз
ui-options-function-text-tab-complete = Автозавершение по Tab
ui-options-function-text-complete-next = Следующее автозавершение
ui-options-function-text-complete-prev = Предыдущее автозавершение
