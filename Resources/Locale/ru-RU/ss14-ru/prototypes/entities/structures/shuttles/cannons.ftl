...
ent-ShuttleGunKineticOld = экзоморфный дематериализатор
    .desc = Древняя корабельная пушка, использующая биомеханические системы для накопления и высвобождения энергии. Хотя её конструкция уникальна, она устарела из-за более медленного заряда и скорости стрельбы по сравнению с механическими аналогами.
